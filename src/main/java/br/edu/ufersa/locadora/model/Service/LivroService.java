...
public class LivroService {
    ...
    public void adicionarLivro(Livro livro) {
        ...
        System.out.prinln(livro.getTitulo() + " adicionado com sucesso.");
    }
    ...
    public Livro lerLivroPorID(String ID) {
    ...
    public void atualizarLivro(Livro livro) {
        ...
        System.out.prinln(livro.getTitulo() + " alterado com sucesso.");
    }
    public void apagarLivro(String ID) {
        if (livroDAO.delete(ID) == null) throw new LivroException("Nenhum livro foi com o ID utilizado (" + ID + ") foi encontrado no banco de dados.");
        else {
